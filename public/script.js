// ======= CONFIGURABLE AREA =========
const NAME = "Your Partner Name";          // Nama panggilan doi
const FROM = "Your Name";             // Namamu
const BDAY = "2025-12-23";            // Tanggal lahir (YYYY-MM-DD)

const WISHES = [
  "ISI DENGAN KALIMAT HARAPAN BUAT PARTNER M",
  "ISI DENGAN KALIMAT HARAPAN BUAT PARTNER M",
  "ISI DENGAN KALIMAT HARAPAN BUAT PARTNER M",
  "ISI DENGAN KALIMAT HARAPAN BUAT PARTNER M",
  "ISI DENGAN KALIMAT HARAPAN BUAT PARTNER MU"
];

// Ganti nama file sesuai fotomu
const GALLERY = [
  { src: "assets/images/grid/22.jpg", caption: "UBAH CAPTION" },
  { src: "assets/images/date.jpg", caption: "UBAH CAPTION" },
  { src: "assets/images/sunset.jpg", caption: "UBAH CAPTION" },
  { src: "assets/images/sport.jpg", caption: "UBAH CAPTION" },
  { src: "assets/images/grid/15.jpg", caption: "UBAH CAPTION" },
  { src: "assets/images/fav.jpg", caption: "UBAH CAPTION" },
  { src: "assets/images/perfek.jpg", caption: "UBAH CAPTION" }
];

// SCRIPT ERROR,  LUPAKAN SAJA
const MOMENTS = [
...
const IG_PHOTOS = [
  "assets/images/your partner .png",
...
igBtn.addEventListener('click', ()=>{
  const u = prompt('Masukkan username Instagram :','YOUR USERNAME');
  if(!u) return;
